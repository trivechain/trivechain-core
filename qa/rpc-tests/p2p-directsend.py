...
'''
DirectSendTest -- test DirectSend functionality (prevent doublespend for unconfirmed transactions)
'''

class DirectSendTest(TrivechainTestFramework):
    def __init__(self):
    ...
    def test_block_doublespend(self):
        ...
        # directsend to receiver
        receiver_addr = receiver.getnewaddress()
        is_id = sender.directsendtoaddress(receiver_addr, 0.9)
    ...
    def test_mempool_doublespend(self):
        ...
        # directsend to receiver. The previously isolated node should prune the doublespend TX and request the correct
        # TX from other nodes.
        receiver_addr = receiver.getnewaddress()
        is_id = sender.directsendtoaddress(receiver_addr, 0.9)
        for node in self.nodes:
