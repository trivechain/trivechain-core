...
#ifndef TRIVECHAIN_QUORUMS_SIGNING_H
#define TRIVECHAIN_QUORUMS_SIGNING_H
...
public:
    ...
    // This is the case for example when a signature appears as part of DirectSend or ChainLocks
    ...
    // mechanism prevents possible conflicts. As an example, ChainLocks prevent conflicts in confirmed TXs DirectSend votes
    void RemoveRecoveredSig(Consensus::LLMQType llmqType, const uint256& id);
...
#endif //TRIVECHAIN_QUORUMS_SIGNING_H
