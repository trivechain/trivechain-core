...
#define BOOST_TEST_MODULE TriveCoin Test Suite

#include "test_trivecoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_trivecoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
