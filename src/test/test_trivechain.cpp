...
#define BOOST_TEST_MODULE Trivechain Test Suite

#include "test_trivechain.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_trivechain_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
