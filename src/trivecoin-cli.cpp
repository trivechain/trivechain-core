...
// Copyright (c) 2009-2015 The Bitcoin Core developersTrivecoin
...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("TriveCoin RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  trivecoin-cli [options] <command> [params]  " + _("Send command to TriveCoin") + "\n" +
                  "  trivecoin-cli [options] help                " + _("List commands") + "\n" +
                  "  trivecoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
