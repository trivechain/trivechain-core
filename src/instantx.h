...
/*
    ...
    one party without comprimising the security of DirectSend
...
*/
static const int DIRECTSEND_CONFIRMATIONS_REQUIRED = 6;
static const int DEFAULT_DIRECTSEND_DEPTH          = 5;

static const int MIN_DIRECTSEND_PROTO_VERSION      = 70208;
...
private:
    ...
    bool IsDirectSendReadyToLock(const uint256 &txHash);

public:
    CCriticalSection cs_directsend;
    ...
    // get directsend confirmations (only)
