...
{
    int nCount = std::min(mnodeman.CountEnabled(MIN_EXCLUSIVESEND_PEER_PROTO_VERSION), 20);
...
void CDarkSendRelay::RelayThroughNode(int nRank)
{
    ...
    if(mnodeman.GetMasternodeByRank(nRank, mnInfo, nBlockHeight, MIN_EXCLUSIVESEND_PEER_PROTO_VERSION)) {
