...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "directsendtoaddress", 1, "address" },
    { "directsendtoaddress", 4, "comment_to" },
    { "settxfee", 0, "amount" },
    ...
    { "sendrawtransaction", 2, "directsend" },
    ...
    { "setexclusivesendrounds", 0, "rounds" },
    { "setexclusivesendamount", 0, "amount" },
