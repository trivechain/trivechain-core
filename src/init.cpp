...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all Trivechain specific functionality (Masternodes, ExclusiveSend, DirectSend, Governance) (0-1, default: %u)"), 0));
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // ********************************************************* Step 11c: update block tip in Trivechain modules
    ...
    // ********************************************************* Step 11d: start trivechain-ps-<smth> threads
