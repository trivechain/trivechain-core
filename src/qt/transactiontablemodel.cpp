...
static int column_alignments[] = {
        ...
        Qt::AlignLeft|Qt::AlignVCenter, /* directsend */
...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::RecvWithExclusiveSend:
        return tr("Received via ExclusiveSend");
    ...
    case TransactionRecord::ExclusiveSendDenominate:
        return tr("ExclusiveSend Denominate");
    case TransactionRecord::ExclusiveSendCollateralPayment:
        return tr("ExclusiveSend Collateral Payment");
    case TransactionRecord::ExclusiveSendMakeCollaterals:
        return tr("ExclusiveSend Make Collateral Inputs");
    case TransactionRecord::ExclusiveSendCreateDenominations:
        return tr("ExclusiveSend Create Denominations");
    case TransactionRecord::ExclusiveSend:
        return tr("ExclusiveSend");
...
QVariant TransactionTableModel::txDirectSendDecoration(const TransactionRecord *wtx) const
{
    if (wtx->status.lockedByDirectSend) {
        QString theme = GUIUtil::getThemeName();
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case RawDecorationRole:
        ...
        case DirectSend:
            return txDirectSendDecoration(rec);
        case ToAddress:
    ...
    case Qt::EditRole:
        ...
        case DirectSend:
            return (rec->status.lockedByDirectSend ? 1 : 0);
        case ToAddress:
    ...
    case Qt::ForegroundRole:
        ...
        if(rec->status.lockedByDirectSend)
        {
    ...
    case WatchonlyDecorationRole:
        return txWatchonlyDecoration(rec);
    case DirectSendRole:
        return rec->status.lockedByDirectSend;
    case DirectSendDecorationRole:
        return txDirectSendDecoration(rec);
...
QVariant TransactionTableModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if(orientation == Qt::Horizontal)
    {
        ...
        } else if (role == Qt::ToolTipRole)
        {
            ...
            case DirectSend:
                return tr("Whether or not this transaction was locked by DirectSend.");
            case ToAddress:
