...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    if(ui->checkUseDirectSend->isChecked()) {
        recipients[0].fUseDirectSend = true;
        strFunds += " ";
        strFunds += tr("and DirectSend");
    } else {
        recipients[0].fUseDirectSend = false;
    }
...
void SendCoinsDialog::updateDirectSend()
{
    ...
    CoinControlDialog::coinControl->fUseDirectSend = ui->checkUseDirectSend->isChecked();
    coinControlUpdateLabels();
}
