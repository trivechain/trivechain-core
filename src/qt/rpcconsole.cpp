...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        connect(model, SIGNAL(dslockCountChanged(size_t)), this, SLOT(setDirectSendLockCount(size_t)));
...
void RPCConsole::setDirectSendLockCount(size_t count)
{
    ui->directSendLockCount->setText(QString::number(count));
}
