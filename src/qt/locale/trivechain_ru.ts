...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Trivechain для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Trivechain для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: если Вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ TRVC&lt;/b&gt;!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Дальнейшая безопасная работа Trivechain невозможна, программа будет закрыта.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Trivechain</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и trivechain: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о Trivechain</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами Trivechain, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами Trivechain</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть trivechain: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Информация о &amp;ExclusiveSend</translation>
    </message>
    <message>
        <source>Show the ExclusiveSend basic information</source>
        <translation>Показать краткую информацию о ExclusiveSend</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное соединение с сетью Trivechain</numerusform><numerusform>%n активных соединения с сетью Trivechain</numerusform><numerusform>%n активных соединений с сетью Trivechain</numerusform><numerusform>%n активных соединений с сетью Trivechain</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Выбраны неанонимизированные средства. &lt;b&gt;ExclusiveSend будет отключен.&lt;/b&gt;&lt;br&gt;&lt;br&gt;Если Вы все-таки хотите использовать ExclusiveSend, пожалуйста, снимите выделение со всех неанонимизированных средств и заново поставьте галочку напротив ExclusiveSend.</translation>
    </message>
    <message>
        <source>(%1 locked)</source>
        <translation>(%1 заблокировано)</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом Trivechain.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;h3&gt;Основы ExclusiveSend&lt;/h3&gt;ExclusiveSend позволяет Вам получить настоящую финансовую конфиденциальность за счет скрытия источников Ваших средств. Все Trivechain в  Вашем кошельке состоят из различных "входов", Вы можете думать о них как об отдельных монетах.&lt;br&gt;ExclusiveSend использует инновационный процесс для перемешивания Ваших входов со входами еще двоих человек, но при этом Ваши монеты никогда не покидают Ваш кошелек. Вы сохраняете контроль над Вашими деньгами на протяжении всего времени.&lt;hr&gt; &lt;b&gt;ExclusiveSend работает так:&lt;/b&gt;&lt;ol type="1"&gt; &lt;li&gt;ExclusiveSend начинается с разбиения Ваших входов транзакций на стандартные номиналы. Такими номиналами являются 0.001 TRVC, 0.01 TRVC, 0.1 TRVC, 1 TRVC и 10 TRVC -- что-то вроде купюр, которыми вы пользуетесь каждый день.&lt;/li&gt; &lt;li&gt;Ваш кошелек затем отправляет запросы к особым образом настроенным сетевым узлам, называемым "мастернодами". Эти мастерноды знают только то, что Вы хотите перемешать определенные номиналы. Никакой идентифицирующей информации мастернодам не отправляется, так что они не знают "кто" Вы конкретно.&lt;/li&gt; &lt;li&gt;Сессия перемешивания начинается тогда, когда еще двое человек отправляют схожее сообщение, подтверждающее, что они хотят перемешать точно такой же номинал. Мастернода перемешивает входы и просит кошельки всех пользователей осуществить платежи по ним. Ваш кошелек осуществляет выплату самому себе, но на другой адрес (тоже из вашего кошелька).&lt;/li&gt; &lt;li&gt;Для скрытия Ваших средств кошелек должен повторить этот процесс несколько раз с каждым номиналом. Каждый раз, когда такой процесс завершается, называется "раундом". С каждым раундом ExclusiveSend становится экспоненциально сложнее определить откуда поступили средства.&lt;/li&gt; &lt;li&gt;Процесс перемешивания выполняется в фоне, без участия пользователя. Когда Вы захотите провести транзакцию, средства уже будут анонимизированы. Дополнительно ждать не требуется.&lt;/li&gt; &lt;/ol&gt; &lt;hr&gt;&lt;b&gt;ВАЖНО:&lt;/b&gt; Ваш кошелек содержит 1000 адресов. Каждое перемешивание использует до 9 из этих адресов. Это означает, что 1000 адресов хватит примерно на 100 перемешиваний. Когда 900 адресов будут уже использованы, Ваш кошелек должен создать новые адреса. Однако, он может сделать это, только если у Вас включены автоматические резервные копии.&lt;br&gt;Соответственно, пользователям с отключенным резервным копированием ExclusiveSend не доступен. &lt;hr&gt;Дополнительная информация доступна в &lt;a href="https://trivechainpay.atlassian.net/wiki/display/DOC/ExclusiveSend"&gt;документации по ExclusiveSend&lt;/a&gt;         </translation>
    </message>
</context>
<context>
    <name>Intro</name>
    ...
    <message>
        ...
        <translation>%1 скачает и сохранит копию цепочки блоков Trivechain.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Скопировать хэш ProTx</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Последние транзакции пока что могут быть не видны и поэтому ваш баланс может отображаться некорректно. Информация будет корректироваться по мере синхронизации с сетью Trivechain, подробности о ходе синхронизации представлены ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Сумма постоянно анонимизированных Trivechain</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показывать дополнительную информацию и кнопки для ExclusiveSend на обзорной вкладке.</translation>
    </message>
    <message>
        <source>Enable advanced ExclusiveSend interface</source>
        <translation>Включить расширенный интерфейс ExclusiveSend</translation>
    </message>
    <message>
        <source>Show warning dialog when ExclusiveSend detects that wallet has very low number of keys left.</source>
        <translation>Показывать предупреждение, когда ExclusiveSend обнаружит, что в кошельке осталось слишком мало ключей.</translation>
    </message>
    <message>
        <source>Warn if ExclusiveSend is running out of keys</source>
        <translation>Предупредить, если кончаются ключи для ExclusiveSend</translation>
    </message>
    <message>
        ...
        <translation>Использовать или нет экспериментальный режим ExclusiveSend с множественным перемешивание за один блок.&lt;br/&gt;Примечание: Используйте с осторожностью.&lt;br/&gt;Убедитесь, что у вас всегда есть (автоматический) бэкап в безопасном месте!</translation>
    </message>
    <message>
        <source>Enable ExclusiveSend &amp;multi-session</source>
        <translation>Включить &amp;мульти-сессионный ExclusiveSend</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Количество раундов ExclusiveSend</translation>
    </message>
    <message>
        <source>This amount acts as a threshold to turn off ExclusiveSend once it's reached.</source>
        <translation>Это пороговое значение, при достижении которого ExclusiveSend отключается.</translation>
    </message>
    <message>
        ...
        <translation>Автоматически открыть порт для Trivechain на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Trivechain через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показывать всплывающие уведомления для транзакций перемешивания ExclusiveSend&lt;br/&gt;также как для всех остальных типов транзакций.</translation>
    </message>
    <message>
        <source>Show popups for ExclusiveSend transactions</source>
        <translation>Показывать всплывающие уведомления для транзакций ExclusiveSend</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Trivechain через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью Trivechain после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Попробовать отправить запрос ExclusiveSend вручную.</translation>
    </message>
    <message>
        ...
        <translation>Сбросить текущий статус ExclusiveSend (можно прервать процесс перемешивания ExclusiveSend, но это может стоить Вам немного денег!)</translation>
    </message>
    <message>
        <source>Information about ExclusiveSend and Mixing</source>
        <translation>Информация о ExclusiveSend и перемешивании</translation>
    </message>
    <message>
        <source>Info</source>
        <translation>Информация</translation>
    ...
    <message>
        ...
        <translation>0 TRVC / 0 раундов</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Баланс ExclusiveSend:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Последнее сообщение ExclusiveSend:
</translation>
    </message>
    <message>
        <source>ExclusiveSend was successfully reset.</source>
        <translation>ExclusiveSend был успешно прерван.</translation>
    </message>
    <message>
        ...
        <translation>Если Вы не хотите видеть внутренние транзакции/комиссии от работы ExclusiveSend, выберите Тип "Наиболее общие" на закладке "Транзакции".</translation>
    </message>
    <message>
        <source>ExclusiveSend requires at least %1 to use.</source>
        <translation>Для работы ExclusiveSend требуется минимум %1.</translation>
    </message>
    <message>
        <source>Wallet is locked and user declined to unlock. Disabling ExclusiveSend.</source>
        <translation>Бумажник заблокирован и пользователь отказался его разблокировать. ExclusiveSend будет выключен.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик trivechain: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес Trivechain либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Trivechain (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть Trivechain.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть Trivechain.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить DirectSend</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>(для работы ExclusiveSend требуется принудительно округлить до ближайшего %1).</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Trivechain</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Trivechain для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придет меньше Trivechain, сем указано в поле "Сумма". Если указано несколько получателей, то комиссия будет разделена между ними поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К trivechain: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть Trivechain.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вы можете подписывать сообщения своими адресами, чтобы доказать, что Вы можете получать Trivechain на них. Будьте осторожны, не подписывайте что-то неопределённое, так как фишинговые атаки могут обманным путём заставить вас подписать нежелательные сообщения. Подписывайте только те сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The Trivechain address to sign the message with</source>
        <translation>Адрес Trivechain, которым Вы хотите подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом Trivechain</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Trivechain, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Trivechain address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Trivechain</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>проверено с помощью DirectSend на основе LLMQ</translation>
    </message>
    <message>
        <source>verified via DirectSend</source>
        <translation>проверено через DirectSend</translation>
    </message>
    <message>
        <source>DirectSend verification in progress - %1 of %2 signatures</source>
        <translation>верификация DirectSend в процессе - %1 из %2 подписей</translation>
    </message>
    <message>
        <source>DirectSend verification failed</source>
        <translation>верификация DirectSend завершилась неудачно</translation>
    </message>
    <message>
        <source>Status</source>
        <translation>Статус</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Получено через ExclusiveSend</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Перемешивание ExclusiveSend</translation>
    </message>
    <message>
        <source>ExclusiveSend Collateral Payment</source>
        <translation>Обеспечительный платеж ExclusiveSend</translation>
    </message>
    <message>
        <source>ExclusiveSend Make Collateral Inputs</source>
        <translation>Создание обеспечительных монет для ExclusiveSend</translation>
    </message>
    <message>
        <source>ExclusiveSend Create Denominations</source>
        <translation>Создание номиналов для ExclusiveSend</translation>
    </message>
    <message>
        <source>ExclusiveSend</source>
        <translation>ExclusiveSend</translation>
    ...
    <message>
        ...
        <translation>Была ли данная транзакция заблокирована с помощью DirectSend.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Заблокировано с помощью DirectSend</translation>
    </message>
    <message>
        <source>Not locked by DirectSend</source>
        <translation>Не заблокировано с помощью DirectSend</translation>
    </message>
    <message>
        <source>Today</source>
...
<context>
    ...
    <message>
        ...
        <translation>DirectSend пока что не поддерживает такие большие суммы. На данный момент транзакции ограничены суммами до %1 TRVC.</translation>
    </message>
    <message>
        <source>Used way too many inputs (&gt;%1) for this DirectSend transaction, fees could be huge.</source>
        <translation>Для этой DirectSend транзакции было использовано слишком много входов (&gt;%1), комиссия может быть огромной.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Включить публикацию кода транзакции при попытке двойной траты другой транзакции, заблокированной через DirectSend, на &lt;address&gt;</translation>
    </message>
    <message>
        <source>Enable publish transaction hashes of attempted DirectSend double spend in &lt;address&gt;</source>
        <translation>Включить публикацию хэша транзакции при попытке двойной траты другой транзакции, заблокированной через DirectSend, на &lt;address&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Установить новый минимум количества подписантов спорков. Полезно только для regtest и devnet. Использование этого параметра на mainnet или testnet приведет к блокировке.</translation>
    </message>
    <message>
        <source>Use N separate masternodes in parallel to mix funds (%u-%u, default: %u)</source>
        <translation>Использовать N отдельных мастернод для параллельного перемешивания средств (%u-%u, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо указать masternodeblsprivkey в кофигурации. Пожалуйста, ознакомьтесь с документацией.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Установить закрытый BLS ключ мастерноды</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Слишком много номиналов %f, пропускаем.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отключить всю функциональность, относящуюся к Trivechain (Мастерноды, ExclusiveSend, DirectSend, Governance) (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Включить DirectSend, показывать подтверждения для заблокированных транзакций (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
        <source>Enable multiple ExclusiveSend mixing sessions per block, experimental (0-1, default: %u)</source>
        <translation>Включить множественное перемешивание ExclusiveSend за один блок (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
        <source>Enable use of automated ExclusiveSend for funds stored in this wallet (0-1, default: %u)</source>
        <translation>Включить автоматическое перемешивание ExclusiveSend для средств, хранящихся в этом кошельке (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
        <source>Execute command when a wallet DirectSend transaction is successfully locked (%s in cmd is replaced by TxID)</source>
        <translation>Выполнить команду, когда транзакция DirectSend успешно заблокирована (%s в команде заменяется на TxID)</translation>
    </message>
    <message>
        <source>Extra transactions to keep in memory for compact block reconstructions (default: %u)</source>
        <translation>Количество дополнительных транзакций, которые нужно держать в памяти для реконструкции компактных блоков (по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>DirectSend требует наличия средств с хотя бы %d подтверждениями, возможно Вам нужно подождать пару минут и попробовать снова.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>При отправке ExclusiveSend использует только деноминированные средства, возможно, Вам просто нужно анонимизировать немного больше монет.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обнаружить достаточных для выполнения этой транзакции номиналов ExclusiveSend.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Вы запускаете кошелек в облегченном режиме, все специфичные для Trivechain функции отключены.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Включить публикацию хэша объектов управления (таких как бюджетные предложения) на &lt;address&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Включить публикацию хэша транзакции (заблокированной через DirectSend) на &lt;address&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Включить публикацию кода транзакции (заблокированной через DirectSend) на &lt;address&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки кэша DirectSend из</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Параметры DirectSend:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Последнее действие ExclusiveSend было слишком недавно.</translation>
    </message>
    <message>
        <source>Last successful ExclusiveSend action was too recent.</source>
        <translation>Последнее успешное действие ExclusiveSend было слишком недавно.</translation>
    </message>
    <message>
        <source>Loading DirectSend data cache...</source>
        <translation>Загрузка кэша DirectSend...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ExclusiveSend в режиме ожидания.</translation>
    </message>
    <message>
        <source>ExclusiveSend options:</source>
        <translation>Опции ExclusiveSend:</translation>
    </message>
    <message>
        <source>ExclusiveSend request complete:</source>
        <translation>Запрос ExclusiveSend завершен:</translation>
    </message>
    <message>
        <source>ExclusiveSend request incomplete:</source>
        <translation>Запрос ExclusiveSend не завершен:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Кошелек не инициализирован</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Вы не можете запустить мастерноду в облегченном режиме.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Предоставлять ликвидность для ExclusiveSend путем редкого участия в перемешивании монет на постоянной основе (%u-%u, по умолчанию: %u, 1=очень часто, высокая комиссия, %u=очень редко, низкая комиссия)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Держать N TRVC анонимизированными (%u-%u, по умолчанию: %u)</translation>
    </message>
    <message>
