...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("TriveCoin trivecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  trivecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trivecoin transaction") + "\n" +
              "  trivecoin-tx [options] -create [commands]   " + _("Create hex-encoded trivecoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded trivecoin transaction
