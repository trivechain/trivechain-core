/* src/config/trivechain-config.h.  Generated from trivechain-config.h.in by configure.  */
/* src/config/trivechain-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TRIVECHAIN_CONFIG_H

#define TRIVECHAIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/trivechain/trivechain/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Trivechain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Trivechain Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "trivechain"
