...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_16_DIRECTSEND_AUTOLOCKS,         4070908800ULL}, // OFF
    {SPORK_17_QUORUM_DKG_ENABLED,            4070908800ULL}, // OFF
    {SPORK_19_CHAINLOCKS_ENABLED,            4070908800ULL}, // OFF
    {SPORK_20_DIRECTSEND_LLMQ_BASED,        4070908800ULL}, // OFF
};
...
int CSporkManager::GetSporkIDByName(const std::string& strName)
{
    ...
    if (strName == "SPORK_16_DIRECTSEND_AUTOLOCKS")            return SPORK_16_DIRECTSEND_AUTOLOCKS;
    ...
    if (strName == "SPORK_20_DIRECTSEND_LLMQ_BASED")           return SPORK_20_DIRECTSEND_LLMQ_BASED;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_16_DIRECTSEND_AUTOLOCKS:            return "SPORK_16_DIRECTSEND_AUTOLOCKS";
        ...
        case SPORK_20_DIRECTSEND_LLMQ_BASED:           return "SPORK_20_DIRECTSEND_LLMQ_BASED";
        default:
