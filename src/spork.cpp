...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            case SPORK_2_DIRECTSEND_ENABLED:               r = SPORK_2_DIRECTSEND_ENABLED_DEFAULT; break;
            case SPORK_3_DIRECTSEND_BLOCK_FILTERING:       r = SPORK_3_DIRECTSEND_BLOCK_FILTERING_DEFAULT; break;
            case SPORK_5_DIRECTSEND_MAX_VALUE:             r = SPORK_5_DIRECTSEND_MAX_VALUE_DEFAULT; break;
            ...
            case SPORK_15_DATA_CARRIER_SIZE:                r = SPORK_15_DATA_CARRIER_SIZE_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        case SPORK_2_DIRECTSEND_ENABLED:               return SPORK_2_DIRECTSEND_ENABLED_DEFAULT;
        case SPORK_3_DIRECTSEND_BLOCK_FILTERING:       return SPORK_3_DIRECTSEND_BLOCK_FILTERING_DEFAULT;
        case SPORK_5_DIRECTSEND_MAX_VALUE:             return SPORK_5_DIRECTSEND_MAX_VALUE_DEFAULT;
        ...
        case SPORK_15_DATA_CARRIER_SIZE:                return SPORK_15_DATA_CARRIER_SIZE_DEFAULT;
        default:
...
{
    if (strName == "SPORK_2_DIRECTSEND_ENABLED")               return SPORK_2_DIRECTSEND_ENABLED;
    if (strName == "SPORK_3_DIRECTSEND_BLOCK_FILTERING")       return SPORK_3_DIRECTSEND_BLOCK_FILTERING;
    if (strName == "SPORK_5_DIRECTSEND_MAX_VALUE")             return SPORK_5_DIRECTSEND_MAX_VALUE;
    ...
    if (strName == "SPORK_15_DATA_CARRIER_SIZE")                return SPORK_15_DATA_CARRIER_SIZE;
...
{
    switch (nSporkID) {
        case SPORK_2_DIRECTSEND_ENABLED:               return "SPORK_2_DIRECTSEND_ENABLED";
        case SPORK_3_DIRECTSEND_BLOCK_FILTERING:       return "SPORK_3_DIRECTSEND_BLOCK_FILTERING";
        case SPORK_5_DIRECTSEND_MAX_VALUE:             return "SPORK_5_DIRECTSEND_MAX_VALUE";
        ...
        case SPORK_15_DATA_CARRIER_SIZE:                return "SPORK_15_DATA_CARRIER_SIZE";
        default:
