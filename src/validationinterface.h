...
protected:
    ...
    virtual void NotifyDirectSendDoubleSpendAttempt(const CTransaction &currentTx, const CTransaction &previousTx) {}
...
struct CMainSignals {
    ...
    /** Notifies listeners of a attempted DirectSend double spend*/
    boost::signals2::signal<void(const CTransaction &currentTx, const CTransaction &previousTx)> NotifyDirectSendDoubleSpendAttempt;
