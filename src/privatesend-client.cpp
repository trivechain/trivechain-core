...
bool CExclusiveSendClientSession::StartNewQueue(CAmount nBalanceNeedsAnonymized, CConnman& connman)
{
    ...
    if (!pwalletMain->SelectExclusiveCoins(CExclusiveSend::GetSmallestDenomination(), nBalanceNeedsAnonymized, vecTxIn, nValueInTmp, 0, exclusiveSendClient.nExclusiveSendRounds - 1)) {
