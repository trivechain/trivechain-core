...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsIncreaseBlock = 752230; // Masternode payment in Trivechain is fixed at 40%
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Trivechain script addresses start with '8'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,18);
        // Testnet Trivechain private keys start with '8' or 'T'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Testnet Trivechain BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Testnet Trivechain BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Testnet Trivechain BIP44 coin type is '1'
        nExtCoinType = 1;
