GENERIC BUILD NOTES
====================
Some notes on how to build Trivechain based on the [depends](../depends/README.md) build system.
...
------------------------------------
Building the dependencies and Trivechain requires some essential build tools to be installed before. Please see
...
This will download and build all dependencies required to build Trivechain. Caching of build results will ensure that only
...
level. `./configure` of Trivechain will autodetect the presence of ccache and enable use of it. To disable ccache, use
