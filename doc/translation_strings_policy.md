...
This document provides guidelines for internationalization of the Trivechain software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `trivechain_en.ts` remains unchanged.
