...
Trivecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Trivecoin Core, where everyone uses
...
pay attention to for reviewers of Trivecoin Core code.

General Trivecoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Trivecoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
