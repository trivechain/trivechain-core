...
- [`98ed90cbb`](https://github.com/dashpay/dash/commit/98ed90cbb) adds rpc calls for `setexclusivesendrounds` and `setexclusivesendamount` (#2230)
...
- [`85a958a36`](https://github.com/dashpay/dash/commit/85a958a36) Drop dummy copy constructors in CExclusiveSend*Session (#2305)
...
- [`43091a3ef`](https://github.com/dashpay/dash/commit/43091a3ef) ExclusiveSend Enhancement: Up default round count to 4 and allow user to mix up to 16 rounds (#2128)
...
- [`624e50949`](https://github.com/dashpay/dash/commit/624e50949) Remove few leftovers of `-directsenddepth`
...
- [`5454bea37`](https://github.com/dashpay/dash/commit/5454bea37) Automatic DirectSend locks for "simple" transactions (#2140)
- [`1e74bcace`](https://github.com/dashpay/dash/commit/1e74bcace) [ZMQ] Notify when an IS double spend is attempted (#2262)
- [`6bcd868de`](https://github.com/dashpay/dash/commit/6bcd868de) Fix lockedByDirectSend initialization (#2197)
- [`0a6f47323`](https://github.com/dashpay/dash/commit/0a6f47323) Remove dummy confirmations in RPC API and GUI for DirectSend transactions (#2040)
- [`ace980834`](https://github.com/dashpay/dash/commit/ace980834) Extend Bloom Filter support to DirectSend related messages (#2184)
- [`2c0d4c9d7`](https://github.com/dashpay/dash/commit/2c0d4c9d7) Save/load DirectSend cache (#2051)
...
- [`3e97b0cbd`](https://github.com/dashpay/dash/commit/3e97b0cbd) Make sure that we can get inputType and fUseDirectSend regardless of the way recipients are sorted (#2550)
...
- [`4a78b161f`](https://github.com/dashpay/dash/commit/4a78b161f) ExclusiveSend spending txes should have "outgoing" icon on overview screen (#2396)
...
- [`e9bb822c1`](https://github.com/dashpay/dash/commit/e9bb822c1) Clang format ExclusiveSend files (#2373)
...
- [`51addf9a0`](https://github.com/dashpay/dash/commit/51addf9a0) Fix p2p-directsend.py test (#2408)
...
- [`59932401b`](https://github.com/dashpay/dash/commit/59932401b) Change internal references of Darksend to ExclusiveSend (#2372)
...
- [`9603c5290`](https://github.com/dashpay/dash/commit/9603c5290) Trivial: Codestyle fixes in DirectSend code (#2332)
...
- [`448e92f4a`](https://github.com/dashpay/dash/commit/448e92f4a) GetOutPointExclusiveSendRounds readability (#2149)
- [`6da2837bd`](https://github.com/dashpay/dash/commit/6da2837bd) DirectSend Integration tests (#2141)
