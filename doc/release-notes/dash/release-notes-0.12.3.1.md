...
- [`ef85d5144`](https://github.com/dashpay/dash/commit/ef85d5144) Comment updates - DirectSend (#2062)
- [`c0a109998`](https://github.com/dashpay/dash/commit/c0a109998) Fix directsend in testnet and regtest (#2016)
...
- [`c0c998da3`](https://github.com/dashpay/dash/commit/c0c998da3) Fix CDirectSend::GetTxLockRequest() (#2006)
...
- [`fcac40ab4`](https://github.com/dashpay/dash/commit/fcac40ab4) RPC: fix wallet lock check in `exclusivesend start` (#2102)
...
- [`ddff32b96`](https://github.com/dashpay/dash/commit/ddff32b96) Fix TransactionRecord::ExclusiveSendMakeCollaterals tx type (#1996)
...
- [`ca89c7b87`](https://github.com/dashpay/dash/commit/ca89c7b87) [Trivial] Update ExclusiveSend denominations in comments / typo fixes (#1910)
...
- [`4d442376e`](https://github.com/dashpay/dash/commit/4d442376e) Limit the scope of cs_wallet lock in CExclusiveSendClient::PrepareDenominate() (#1997)
...
- [`fa2549986`](https://github.com/dashpay/dash/commit/fa2549986) Swap iterations and fUseDirectSend parameters in ApproximateBestSubset (#1819)
...
- [`6ab1fd763`](https://github.com/dashpay/dash/commit/6ab1fd763) RPC: Add description for DirectSend-related fields of mempool entry (#2050)
...
- [`86d33b276`](https://github.com/dashpay/dash/commit/86d33b276) Remove double registration of "exclusivesend" RPC (#1853)
...
- [`a9d8e2c5d`](https://github.com/dashpay/dash/commit/a9d8e2c5d) [Init] Avoid segfault when called with -enabledirectsend=0 (#1976)
...
- [`4528c735f`](https://github.com/dashpay/dash/commit/4528c735f) Replace some directsend/exclusivesend magic numbers with constants (#1924)
