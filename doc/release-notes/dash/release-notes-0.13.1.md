...
See detailed [set of changes](https://github.com/trivechain/trivechain/compare/v0.13.0.0...trivechainpay:v0.13.1.0).

### Backports

- [`da5a861c0`](https://github.com/trivechain/trivechain/commit/da5a861c0) Change the way invalid ProTxes are handled in `addUnchecked` and `existsProviderTxConflict` (#2691)
- [`6ada90c11`](https://github.com/trivechain/trivechain/commit/6ada90c11) Call existsProviderTxConflict after CheckSpecialTx (#2690)
- [`23eb70cb7`](https://github.com/trivechain/trivechain/commit/23eb70cb7) Add getspecialtxes rpc (#2668)
- [`023f8a01a`](https://github.com/trivechain/trivechain/commit/023f8a01a) Fix bench log for payee and special txes (#2678)
- [`8961a6acc`](https://github.com/trivechain/trivechain/commit/8961a6acc) Stop checking MN protocol version before signalling DIP3 (#2684)
...
- [`bd0de4876`](https://github.com/trivechain/trivechain/commit/bd0de4876) Bump version to 0.13.1 (#2686)
