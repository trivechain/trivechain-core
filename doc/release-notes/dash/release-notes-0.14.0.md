...
- [`84162021a`](https://github.com/dashpay/dash/commit/84162021a) Fix duplicate `-directsendnotify` invocation (#2925)
...
- [`66a2cdeaf`](https://github.com/dashpay/dash/commit/66a2cdeaf) Properly handle conflicts between ChainLocks and DirectSend (#2904)
...
- [`5d05ab17a`](https://github.com/dashpay/dash/commit/5d05ab17a) Fix ExclusiveSend log (#2892)
...
- [`7fe1a4a78`](https://github.com/dashpay/dash/commit/7fe1a4a78) Also invoke WriteDirectSendLockMined when IS lock comes after the mined block (#2861)
...
- [`90b1b7196`](https://github.com/dashpay/dash/commit/90b1b7196) Move processing of DirectSend locks into its own worker thread (#2857)
...
- [`206e5a1b4`](https://github.com/dashpay/dash/commit/206e5a1b4) Use big endian inversed height in CDirectSendDb
...
- [`4577438e8`](https://github.com/dashpay/dash/commit/4577438e8) Implement RemoveConfirmedDirectSendLocks to prune confirmed IS locks from DB
...
- [`208406df7`](https://github.com/dashpay/dash/commit/208406df7) Re-introduce nDirectSendKeepLock check for LLMQ-based IS when spork19 is OFF (#2829)
...
- [`b87821047`](https://github.com/dashpay/dash/commit/b87821047) Make LLMQ/DirectSend/ChainLocks code less spammy (#2781)
...
- [`5299d3933`](https://github.com/dashpay/dash/commit/5299d3933) Multiple refactorings/fixes for LLMQ bases DirectSend and ChainLocks (#2779)
- [`a5d2edbe0`](https://github.com/dashpay/dash/commit/a5d2edbe0) Relay spork after updating internal spork maps (#2777)
- [`e52763d21`](https://github.com/dashpay/dash/commit/e52763d21) Refactor and fix directsend tests/utils (#2776)
...
- [`6350adf1b`](https://github.com/dashpay/dash/commit/6350adf1b) Slightly refactor ProcessDirectSendLock (#2767)
...
- [`ac00c6628`](https://github.com/dashpay/dash/commit/ac00c6628) Make DirectSend locks persistent
...
- [`06fc65559`](https://github.com/dashpay/dash/commit/06fc65559) Actually remove from finalDirectSendLocks in CDirectSendManager::RemoveFinalISLock
...
- [`4d3365ddb`](https://github.com/dashpay/dash/commit/4d3365ddb) Completely disable DirectSend while filling mempool in autoix-mempool.py
...
- [`3e60d2d2d`](https://github.com/dashpay/dash/commit/3e60d2d2d) Adjust LLMQ based DirectSend tests for new spork20
- [`41a71fe44`](https://github.com/dashpay/dash/commit/41a71fe44) update autoix-mempool.py to test both "old" and "new" DirectSend (and fix CheckCanLock to respect mempool limits)
- [`843b6d7a9`](https://github.com/dashpay/dash/commit/843b6d7a9) update p2p-autodirectsend.py to test both "old" and "new" DirectSend
- [`a8da11ac5`](https://github.com/dashpay/dash/commit/a8da11ac5) update p2p-directsend.py to test both "old" and "new" DirectSend
- [`55152cb31`](https://github.com/dashpay/dash/commit/55152cb31) Move IS block filtering into ConnectBlock
- [`2299ee283`](https://github.com/dashpay/dash/commit/2299ee283) Rename IXLOCK to ISLOCK and InstantX to DirectSend
- [`f5dcb00ac`](https://github.com/dashpay/dash/commit/f5dcb00ac) Introduce spork SPORK_20_DIRECTSEND_LLMQ_BASED to switch between new/old system
...
- [`e2f99f4ae`](https://github.com/dashpay/dash/commit/e2f99f4ae) Set llmqForDirectSend for mainnet and testnet
...
- [`3a6cc2cc1`](https://github.com/dashpay/dash/commit/3a6cc2cc1) Show "verified via LLMQ based DirectSend" in GUI TX status
...
- [`83dbcc483`](https://github.com/dashpay/dash/commit/83dbcc483) Implement CDirectSendManager and related P2P messages
...
- [`8e4fe3660`](https://github.com/dashpay/dash/commit/8e4fe3660) [ExclusiveSend] Fallback to less participants if possible, fix too long timeouts on server side (#2616)
...
- [`fa18d3e10`](https://github.com/dashpay/dash/commit/fa18d3e10) More fixes for ExclusiveSend after 2612 (#2614)
- [`bade33273`](https://github.com/dashpay/dash/commit/bade33273) Fix 2612 (#2613)
- [`5c5932eb9`](https://github.com/dashpay/dash/commit/5c5932eb9) [ExclusiveSend] Allow more than 3 mixing participants (#2612)
...
- [`fb13b000b`](https://github.com/dashpay/dash/commit/fb13b000b) Remove support for legacy operator keys in CExclusiveSendBroadcastTx
- [`5f5fcc49c`](https://github.com/dashpay/dash/commit/5f5fcc49c) Remove legacy signatures support in CExclusiveSendQueue
