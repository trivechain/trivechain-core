...
dashd/trivechain-qt (on Linux). Because of the per-UTXO fix (see below) there is a
...
### ExclusiveSend:
- [`7e96af4e6`](https://github.com/dashpay/dash/commit/7e96af4e6) Refactor ExclusiveSend (#1735)
...
- [`f37a64208`](https://github.com/dashpay/dash/commit/f37a64208) DirectSend txes should never qualify to be a 0-fee txes (#1777)
