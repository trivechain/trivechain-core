...
-----------------------
Building the dependencies and Trivechain Core requires some essential build tools and libraries to be installed before.
...
Add `CC=egcc CXX=eg++ CPP=ecpp` to the dependencies build and the Trivechain Core build:
```bash
$ cd depends
