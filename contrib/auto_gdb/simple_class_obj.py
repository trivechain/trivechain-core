...
simple_types = ["CMasternode", "CMasternodeVerification",
                ...
                "CTransaction", "CMutableTransaction", "CExclusiveSendBaseSession",
                "CExclusiveSendBaseManager", "CExclusiveSendClientSession",
                "CExclusiveSendClientManager", "CExclusiveSendServer", "CMasternodePayments",
                "CMasternodePaymentVote", "CMasternodeBlockPayees",
                "CMasternodePayee", "CDirectSend", "CTxLockRequest",
